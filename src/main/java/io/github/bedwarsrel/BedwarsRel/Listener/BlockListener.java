...
public class BlockListener extends BaseListener {
    ...
    public void onSpread(BlockSpreadEvent spread) {
        ...
        Game game =
                Main.getInstance().getGameManager().getGameByLocation(spread.getBlock().getLocation());
        if (game == null) {
            return;
        }
    ...
    public void onForm(BlockFormEvent form) {
        ...
        Game game =
                Main.getInstance().getGameManager().getGameByLocation(form.getBlock().getLocation());
        if (game == null) {
            return;
        }
    ...
    public void onBlockGrow(BlockGrowEvent grow) {
        ...
        Game game =
                Main.getInstance().getGameManager().getGameByLocation(grow.getBlock().getLocation());
        if (game == null) {
            return;
        }
            ...
            if (!Main.getInstance().getBooleanConfig("friendlybreak", true)) {
                ...
                for (Player player : playerTeam.getPlayers()) {
                    ...
                    if (player.getLocation().getBlock().getRelative(BlockFace.DOWN).equals(e.getBlock())) {
                        p.sendMessage(
                                ChatHelper.with(ChatColor.RED + Main.local("ingame.no-friendlybreak")));
                        e.setCancelled(true);
                        return;
                    }
                }
            ...
            if (e.getBlock().getType() == Material.ENDER_CHEST) {
                for (Team team : g.getTeams().values()) {
                    ...
                    if (teamChests.contains(breakedBlock)) {
                        ...
                        g.broadcast(Main.local("ingame.teamchestdestroy"), team.getPlayers());
                        break;
                    }
                }
                ...
                meta.setDisplayName(Main.local("ingame.teamchest"));
    ...
    public void onIgnite(BlockIgniteEvent ignite) {
        ...
        if (ignite.getIgnitingBlock() == null) {
            if (ignite.getIgnitingEntity() instanceof Player) {
                game = Main.getInstance().getGameManager()
