...
public class WarpPowder extends SpecialItem {
    ...
    public void cancelTeleport(boolean removeSpecial, boolean showMessage) {
        ...
        if (showMessage) {
            this.player
                    .sendMessage(ChatHelper.with(Main.local("ingame.specials.warp-powder.cancelled")));
        }
    ...
    private ItemStack getCancelItemStack() {
        ...
        meta.setDisplayName(Main.local("ingame.specials.warp-powder.cancel"));
    ...
    public void runTask() {
        ...
        this.teleportingTime =
                (double) Main.getInstance().getIntConfig("specials.warp-powder.teleport-time", 6);
        this.player.sendMessage(ChatHelper.with(Main.local("ingame.specials.warp-powder.start",
