...
public class Tracker extends SpecialItem {
    ...
    public void trackPlayer() {
        ...
        if (target == null) {
            this.player.sendMessage(ChatHelper
                    .with(ChatColor.RED + Main.local("ingame.specials.tracker.no-target-found")));
        ...
        this.player.sendMessage(ChatHelper.with(Main.local("ingame.specials.tracker.target-found",
