...
public class SetTargetCommand extends BaseCommand implements ICommand {
    ...
    public String getName() {
        return Main.local("commands.settarget.name");
    }

    @Override
    public String getDescription() {
        return Main.local("commands.settarget.desc");
    }
    ...
    public boolean execute(CommandSender sender, ArrayList<String> args) {
        ...
        if (targetBlock == null || standingBlock == null) {
            player.sendMessage(ChatHelper.with(ChatColor.RED + Main.local("errors.bedtargeting")));
            return false;
        }
        ...
        player.sendMessage(ChatHelper.with(ChatColor.GREEN + Main.local("success.bedset",
