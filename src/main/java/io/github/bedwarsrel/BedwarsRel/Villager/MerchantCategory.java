...
public class MerchantCategory {
            ...
            for (Object offer : section.getList(cat + ".offers")) {
                ...
                if (item1 == null || reward == null) {
                    Main.getInstance().getServer().getConsoleSender().sendMessage(
                            ChatHelper.with(ChatColor.RED + "Couldn't parse item in category \""
    ...
    public static void openCategorySelection(Player p, Game g) {
        ...
        Inventory inv = Bukkit.createInventory(p, size, Main.local("ingame.shop.name"));
        ...
        snowMeta.setDisplayName(Main.local("ingame.shop.newshop"));
