...
public class TNTSheepRegister implements ITNTSheepRegister {
    ...
    public void registerEntities(int entityId) {
      ...
      /*
       * try { Method a = EntityTypes.class.getDeclaredMethod("a", Class.class, String.class,
       * int.class); a.setAccessible(true); a.invoke(a, TNTCreature.class, "TNTCreature", entityId);
       * } catch (Exception ignored) { // Do some cleanup and error-handling here. }
       */
