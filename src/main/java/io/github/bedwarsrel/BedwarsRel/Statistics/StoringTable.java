    ...
    public Object getValue(String field) {
        try {
            ...
            Main.getInstance().getServer().getConsoleSender()
                    .sendMessage(ChatHelper.with("Couldn't fetch value of field: " + field));
        }
    ...
    public void setValue(String field, Object value) {
        ...
        try {
            ...
            try {
                ...
                Main.getInstance().getBugsnag().notify(ex);
                Main.getInstance().getServer().getConsoleSender()
                        .sendMessage(ChatHelper.with("Couldn't cast value for field: " + field));
            }
        } catch (Exception ex) {
            Main.getInstance().getBugsnag().notify(ex);
            Main.getInstance().getServer().getConsoleSender()
                    .sendMessage(ChatHelper.with("Couldn't set value of field: " + field));
        }
    }
}
